...
<body class="app-body">
  ...
  <div id="app" class="app-wrapper">
    <nav class="navbar navbar-expand-lg app-navbar shadow-sm">
      <div class="container-xxl">
        <a class="navbar-brand" href="{{ url('/') }}">
          <span class="brand-mark">{{ config('app.name', 'phpIP') }}</span>
        </a>
            ...
            @else
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  <li><a class="dropdown-item" href="{{ url('/matter') }}">{{ __('All') }}</a></li>
                  <li><a class="dropdown-item" href="{{ url('/matter?display_with=PAT') }}">{{ __('Patents') }}</a></li>
                  <li><a class="dropdown-item" href="{{ url('/matter?display_with=TM') }}">{{ __('Trademarks') }}</a></li>
                  @can('readwrite')
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="/matter/create?operation=new" data-bs-target="#ajaxModal" data-bs-toggle="modal" data-size="modal-sm" title="{{ __('Create Matter') }}">{{ __('Create') }}</a></li>
                    <li><a class="dropdown-item" href="/matter/create?operation=ops" data-bs-target="#ajaxModal" data-bs-toggle="modal" data-size="modal-sm" title="{{ __('Create family from OPS') }}">{{ __('Create family from OPS') }}</a></li>
                  @endcan
                </ul>
              </li>
              ...
              @can('readonly')
                @can('readwrite')
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                      <li><a class="dropdown-item" href="{{ url('/renewal') }}">{{ __('Manage renewals') }}</a></li>
                      <li><a class="dropdown-item" href="{{ url('/fee') }}">{{ __('Renewal fees') }}</a></li>
                      @can('admin')
                        <li><a class="dropdown-item" href="{{ url('/rule') }}">{{ __('Rules') }}</a></li>
                        <li><a class="dropdown-item" href="{{ url('/document') }}">{{ __('Email template classes') }}</a></li>
                        <li><a class="dropdown-item" href="{{ url('/countries') }}">{{ __('Country Management') }}</a></li>
                        <li><a class="dropdown-item" href="{{ url('/template-member') }}">{{ __('Email templates') }}</a></li>
                      @endcan
                    </ul>
                  </li>
                @endcan
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    @can('admin')
                      <li><a class="dropdown-item" href="{{ url('/user') }}">{{ __('DB Users') }}</a></li>
    ...
    <main class="app-main container-xxl py-5">
      @yield('content')
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content glass-card">
            <div class="modal-header">
              <h1 class="modal-title fs-4">Ajax title placeholder</h1>
            ...
            <div class="modal-footer">
              <span id="footerAlert" class="alert float-start mb-0"></span>
