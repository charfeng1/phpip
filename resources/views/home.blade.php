    ...
    <div class="card bg-base-100 shadow-sm border border-base-300">
      ...
      <div class="card-body p-6" id="tasklist">
        <div class="flex flex-col items-center justify-center py-8 text-base-content/50">
          ...
          <h6 class="font-medium">{{ __('Loading tasks...') }}</h6>
          <p class="text-sm">{{ __('Please wait while we fetch your tasks') }}</p>
        </div>
      </div>
    </div>
    ...
    <div class="card bg-base-100 shadow-sm border border-base-300">
      ...
      <div class="card-body p-6" id="renewallist">
        <div class="flex flex-col items-center justify-center py-8 text-base-content/50">
          ...
          <h6 class="font-medium">{{ __('Loading renewals...') }}</h6>
          <p class="text-sm">{{ __('Fetching upcoming renewal deadlines') }}</p>
        </div>
      </div>
    </div>
  </div>
