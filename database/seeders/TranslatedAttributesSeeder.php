...
class TranslatedAttributesSeeder extends Seeder
{
    ...
    /**
     * Get classifier type translations for ClassifierTypeTableSeeder
     *
     * @return array<string, array<string, string>>
     */
    public static function getClassifierTypes(): array
    {
        return [
    ...
    /**
     * Get event name translations for EventNameTableSeeder
     *
     * @return array<string, array<string, string>>
     */
    public static function getEventNames(): array
    {
        return [
            ...
            'EXA' => ['en' => 'Examiner Action',     'fr' => 'Notification d\'examen',   'de' => 'Prüferbescheid', 'zh' => '审查意见'],
            'EXAF' => ['en' => 'Examiner Action (Final)', 'fr' => 'Notif. Exa. (Finale)', 'de' => 'Schlussbescheid Prüfer', 'zh' => '审查意见（终局）'],
            'EXP' => ['en' => 'Expiry',              'fr' => 'Expiration',               'de' => 'Ablauf', 'zh' => '届满'],
            ...
            'FDIV' => ['en' => 'File Divisional',     'fr' => 'Déposer divisionnaire',    'de' => 'Teilanmeldung einreichen', 'zh' => '提交分案'],
            ...
            'INV' => ['en' => 'Invalidated',         'fr' => 'Invalidé',                 'de' => 'Für ungültig erklärt', 'zh' => '无效'],
            'IPER' => ['en' => 'International Preliminary Examination Report', 'fr' => 'Rapport d\'examen préliminaire international', 'de' => 'Internationaler vorläufiger Prüfungsbericht', 'zh' => '国际初步审查报告'],
            'LAP' => ['en' => 'Lapsed',              'fr' => 'Déchu',                    'de' => 'Verfallen', 'zh' => '失效'],
            'NPH' => ['en' => 'National Phase',      'fr' => 'Phase nationale',          'de' => 'Nationale Phase', 'zh' => '国家阶段'],
            'OPP' => ['en' => 'Opposition',          'fr' => 'Opposition',               'de' => 'Einspruch', 'zh' => '异议'],
            'ORI' => ['en' => 'Original',            'fr' => 'Original',                 'de' => 'Original', 'zh' => '原始'],
            'OPR' => ['en' => 'Oral Proceedings',    'fr' => 'Procédure orale',          'de' => 'Mündliche Verhandlung', 'zh' => '口头审理'],
            'ORE' => ['en' => 'Opposition rejected', 'fr' => 'Opposition rejetée',       'de' => 'Einspruch zurückgewiesen', 'zh' => '异议被驳回'],
            ...
            'PFIL' => ['en' => 'Parent Filed',        'fr' => 'Dépôt parent',             'de' => 'Stammanmeldung eingereicht', 'zh' => '母案提交'],
            ...
            'PRI' => ['en' => 'Priority Claim',      'fr' => 'Revendication priorité',   'de' => 'Prioritätsanspruch', 'zh' => '优先权'],
            'PRID' => ['en' => 'Priority Deadline',   'fr' => 'Délai priorité',           'de' => 'Prioritätsfrist', 'zh' => '优先权期限'],
            'PROD' => ['en' => 'Produce',             'fr' => 'Produire',                 'de' => 'Erstellen/Einreichen', 'zh' => '提供'],
            ...
            'REJF' => ['en' => 'Rejection Final',     'fr' => 'Rejet définitif',          'de' => 'Endgültige Ablehnung', 'zh' => '最终驳回'],
            ...
            'REST' => ['en' => 'Restored',            'fr' => 'Restauré',                 'de' => 'Wiederhergestellt', 'zh' => '恢复'],
            'REQ' => ['en' => 'Request',             'fr' => 'Requête',                  'de' => 'Antrag', 'zh' => '请求'],
            'RSTR' => ['en' => 'Restriction Req.',    'fr' => 'Requête restriction',      'de' => 'Beschränkungsantrag', 'zh' => '限制请求'],
            'SOL' => ['en' => 'Sold',                'fr' => 'Vendu',                    'de' => 'Verkauft', 'zh' => '已转让'],
            'SOP' => ['en' => 'Summons to Oral Proc.', 'fr' => 'Citation proc. orale',   'de' => 'Ladung zur Mündl. Verh.', 'zh' => '传唤口头审理'],
            'SR' => ['en' => 'Search Report',       'fr' => 'Rapport de recherche',     'de' => 'Recherchenbericht', 'zh' => '检索报告'],
            'SUS' => ['en' => 'Suspended',           'fr' => 'Suspendu',                 'de' => 'Ausgesetzt', 'zh' => '中止'],
            'SUO' => ['en' => 'Summons Oral',        'fr' => 'Convocation procédure orale', 'de' => 'Ladung mündliche Verhandlung', 'zh' => '传唤口头审理'],
            'TRF' => ['en' => 'Transformation',      'fr' => 'Transformation',           'de' => 'Transformation', 'zh' => '转化'],
            'TRS' => ['en' => 'Transfer',            'fr' => 'Transfert',                'de' => 'Übertragung', 'zh' => '转让'],
            'VAL' => ['en' => 'Validate',            'fr' => 'Valider',                  'de' => 'Validieren', 'zh' => '验证'],
            'WAT' => ['en' => 'Watch',               'fr' => 'Surveiller',               'de' => 'Überwachen', 'zh' => '监视'],
            'WIT' => ['en' => 'Withdrawal',          'fr' => 'Retrait',                  'de' => 'Zurücknahme', 'zh' => '撤回'],
            'WO' => ['en' => 'PCT',                 'fr' => 'PCT',                      'de' => 'PCT', 'zh' => 'PCT'],
        ];
    }
     ...
     */
    public static function getTaskRuleDetails(): array
    {
        $commonTranslations = [
            'clear' => ['en' => 'Clear', 'fr' => 'Acquitter', 'de' => 'Erfüllen', 'zh' => '清除'],
            'delete' => ['en' => 'Delete', 'fr' => 'Supprimer', 'de' => 'Löschen', 'zh' => '删除'],
        ...
        return [
            3 => $commonTranslations['clear'],
            5 => $commonTranslations['clear'],
            6 => $commonTranslations['examination'],
            7 => $commonTranslations['examination'],
            9 => ['en' => 'Search Report', 'fr' => 'Rapport de Recherche', 'de' => 'Recherchenbericht', 'zh' => '检索报告'],
            10 => $commonTranslations['examReport'],
            11 => $commonTranslations['examReport'],
            13 => $standardizedValues['r71_3'],
            14 => $commonTranslations['grantFee'],
            ...
            18 => $commonTranslations['written'],
            19 => ['en' => 'Designation Fees', 'fr' => 'Taxes de Désignation', 'de' => 'Benennungsgebühren', 'zh' => '指定费'],
            20 => $commonTranslations['declaration'],
            21 => ['en' => 'Priority Deadline', 'fr' => 'Délai de Priorité', 'de' => 'Prioritätsfrist', 'zh' => '优先权期限'],
            23 => $commonTranslations['examination'],
            25 => $commonTranslations['delete'],
            29 => $commonTranslations['clear'],
            30 => $standardizedValues['ids'],
            31 => $commonTranslations['examination'],
            ...
            38 => $commonTranslations['clear'],
            39 => $commonTranslations['grantFee'],
            41 => $standardizedValues['r70_2'],
            ...
            47 => $standardizedValues['r161'],
            49 => $commonTranslations['appeal'],
            52 => $commonTranslations['observations'],
            53 => $commonTranslations['examination'],
            54 => $commonTranslations['examination'],
            55 => $commonTranslations['examination'],
            56 => $commonTranslations['grantFee'],
            ...
            61 => $commonTranslations['examReport'],
            62 => $commonTranslations['examReport'],
            63 => $commonTranslations['extension'],
            64 => $commonTranslations['extension'],
            66 => $commonTranslations['grantFee'],
            67 => $standardizedValues['r70_2'],
            68 => ['en' => 'Designation Fees', 'fr' => 'Taxes de Désignation', 'de' => 'Benennungsgebühren', 'zh' => '指定费'],
            69 => $commonTranslations['written'],
            70 => $commonTranslations['examination'],
            80 => $commonTranslations['recurring'],
            81 => $commonTranslations['recurring'],
            234 => $commonTranslations['grantFee'],
            235 => $commonTranslations['written'],
            236 => $commonTranslations['grantFee'],
            237 => ['en' => 'Working Report', 'fr' => 'Rapport d\'Exploitation', 'de' => 'Nutzungsbericht', 'zh' => '工作报告'],
            238 => $commonTranslations['opposition'],
            239 => $commonTranslations['opposition'],
            240 => $commonTranslations['opposition'],
            242 => ['en' => 'Declaration of use', 'fr' => 'Déclaration d\'Usage', 'de' => 'Benutzungserklärung', 'zh' => '使用声明'],
            1280 => $commonTranslations['observations'],
            ...
            1300 => $commonTranslations['observations'],
            1301 => $commonTranslations['declaration'],
            1302 => $commonTranslations['examination'],
            1303 => $commonTranslations['appeal'],
            1306 => $commonTranslations['delete'],
            1307 => $commonTranslations['delete'],
            1310 => ['en' => 'Opinion', 'fr' => 'Avis', 'de' => 'Gutachten', 'zh' => '意见书'],
            1311 => ['en' => 'Report', 'fr' => 'Rapport', 'de' => 'Bericht', 'zh' => '报告'],
            1315 => $commonTranslations['examReport'],
            1316 => $standardizedValues['poa'],
            1321 => ['en' => 'Analysis of SR', 'fr' => 'Analyse du Rap. Rech.', 'de' => 'Analyse Rech.ber.', 'zh' => '检索报告分析'],
            1322 => $commonTranslations['appeal'],
            1323 => $standardizedValues['rce'],
            1326 => ['en' => 'Appeal', 'fr' => 'Recours', 'de' => 'Beschwerde', 'zh' => '上诉'],
            1327 => $commonTranslations['clear'],
    ...
    public function run()
    {
        ...
        // Use static getter methods as single source of truth
        $eventNames = static::getEventNames();
        $this->updateTable('event_name', 'code', 'name', $eventNames);

        $matterCategories = static::getMatterCategories();
        $this->updateTable('matter_category', 'code', 'category', $matterCategories);

        $matterTypes = static::getMatterTypes();
        $this->updateTable('matter_type', 'code', 'type', $matterTypes);

        $actorRoles = static::getActorRoles();
        $this->updateTable('actor_role', 'code', 'name', $actorRoles);

        $classifierTypes = static::getClassifierTypes();
        $this->updateTable('classifier_type', 'code', 'type', $classifierTypes);

        $taskRuleDetails = static::getTaskRuleDetails();
        $this->updateTable('task_rules', 'id', 'detail', $taskRuleDetails);
